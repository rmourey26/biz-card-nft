...
DROP POLICY IF EXISTS "Allow anonymous access to public business cards" ON public.business_cards;
...
DROP POLICY IF EXISTS "Allow public access to business cards" ON public.business_cards;
...
CREATE POLICY "Allow public access to business cards" 
